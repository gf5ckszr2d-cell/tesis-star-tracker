...
set_property -dict { PACKAGE_PIN D17 IOSTANDARD LVCMOS33 } [get_ports { cam_data[5] }]          ;# JA7  -> SDA
set_property -dict { PACKAGE_PIN D18 IOSTANDARD LVCMOS33 } [get_ports { cam_vsync }]    ;# JA2  -> VS
set_property -dict { PACKAGE_PIN E17 IOSTANDARD LVCMOS33 } [get_ports { cam_data[3] }]     ;# JA8  -> HS/HREF
set_property -dict { PACKAGE_PIN E18 IOSTANDARD LVCMOS33 } [get_ports { cam_pclk }]     ;# JA3  -> PCLK/PLK
set_property -dict { PACKAGE_PIN F18 IOSTANDARD LVCMOS33 } [get_ports { cam_data[1] }]     ;# JA9  -> XCLK/XLK
set_property -dict { PACKAGE_PIN G17 IOSTANDARD LVCMOS33 } [get_ports { cam_data[7] }]  ;# JA4  -> D7
set_property -dict { PACKAGE_PIN G18 IOSTANDARD LVCMOS33 } [get_ports { cam_reset }]  ;# JA10 -> D6 cam_data[6

## JB row pairs: JB1/JB7, JB2/JB8, JB3/JB9, JB4/JB10.
set_property -dict { PACKAGE_PIN D14 IOSTANDARD LVCMOS33 } [get_ports { SDA }]  ;# JB1  -> D5
set_property PULLUP true [get_ports { SDA }]
set_property -dict { PACKAGE_PIN E16 IOSTANDARD LVCMOS33 } [get_ports { cam_data[4] }]  ;# JB7  -> D4
set_property -dict { PACKAGE_PIN F16 IOSTANDARD LVCMOS33 } [get_ports { cam_href }]  ;# JB2  -> D3
set_property -dict { PACKAGE_PIN F13 IOSTANDARD LVCMOS33 } [get_ports { cam_data[2] }]  ;# JB8  -> D2
set_property -dict { PACKAGE_PIN G16 IOSTANDARD LVCMOS33 } [get_ports { cam_xclk }]  ;# JB3  -> D1
set_property -dict { PACKAGE_PIN G13 IOSTANDARD LVCMOS33 } [get_ports { cam_data[0] }]  ;# JB9  -> D0
set_property -dict { PACKAGE_PIN H14 IOSTANDARD LVCMOS33 } [get_ports { cam_data[6] }]    ;# JB4  -> RESET/RET
